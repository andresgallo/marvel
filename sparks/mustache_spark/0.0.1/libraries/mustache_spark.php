...
require_once SPARKPATH.'mustache_spark/0.0.1/vendor/Mustache.php';
...
class Mustache_spark
{
	...
	private function get_include_contents($template)
	{
		...
		$file_path = PUBLICHTML.'views/'.$template.'.tpl';
	...
	{
		$vendor_library_path = SPARKPATH.'mustache_spark/0.0.1/vendor/Mustache.php';
